      ...
      <Dropdown.Toggle as={DropdownTopbarItemToggler} id="dropdown-toggle-user-profile">
        <div className={'btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2'}>
          ...
          <span className="symbol symbol-35 symbol-light-success">
            <span className="symbol-label font-size-h5 font-weight-bold">{user.nama_user[0]}</span>
          </span>
        </div>
      </Dropdown.Toggle>
        ...
        <>
          {!layoutProps.light && (
            <div
              ...
              <div className="text-white m-0 flex-grow-1 mr-3 font-size-h5">{user.nama_user}</div>
              <span className="label label-success label-lg font-weight-bold label-inline">
                {user.peran_user.peran}
              </span>
            </div>
          )}
        </>
