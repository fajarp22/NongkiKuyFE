            ...
            <div className="symbol symbol-40 symbol-light-warning mr-5">
              <span className="symbol-label">
                <span className="svg-icon svg-icon-lg svg-icon-warning">
                  <SVG
                    className="h-75 align-self-end"
                    src={toAbsoluteUrl('/media/svg/icons/Communication/Write.svg')}></SVG>
                </span>
              </span>
            </div>
            <div className="d-flex flex-column font-weight-bold">
            ...
            <div className="symbol symbol-40 symbol-light-success mr-5">
              <span className="symbol-label">
                <span className="svg-icon svg-icon-lg svg-icon-success">
                  <SVG
                    className="h-75 align-self-end"
                    src={toAbsoluteUrl('/media/svg/icons/Communication/Group-chat.svg')}></SVG>
                </span>
              </span>
            </div>
            ...
            <div className="symbol symbol-40 symbol-light-danger mr-5">
              <span className="symbol-label">
                <span className="svg-icon svg-icon-lg svg-icon-danger">
                  <SVG
                    className="h-75 align-self-end"
                    src={toAbsoluteUrl('/media/svg/icons/General/Attachment2.svg')}></SVG>
                </span>
              </span>
            </div>
            ...
            <div className="symbol symbol-40 symbol-light-info mr-5">
              <span className="symbol-label">
                <span className="svg-icon svg-icon-lg  svg-icon-info">
                  <SVG
                    className="h-75 align-self-end"
                    src={toAbsoluteUrl('/media/svg/icons/Communication/Shield-user.svg')}></SVG>
                </span>
              </span>
            </div>
