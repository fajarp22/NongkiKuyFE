...
export function DataSBGEditPelunasanPenuh({ dataSBG, show, onHide, user, notify }) {
  // Redux
      ...
      transactionAPI
        ...
        .then(data => {
          if (data.status === 'success') {
            ...
            transactionAPI.SBPel(data.data).then(data => {
    ...
    <>
      <Modal centered size="md" show={show} onHide={onHide}>
        <Modal.Header closeButton={true}>
          <Modal.Title>Pelunasan {dataSBG?.mortgageCode}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            <Form.Group>
