...
function EmailSettings(props) {
  ...
  const initialValues = {
    ...
    newsAboutKeenthemesProductsAndFeatureUpdates:
      user.emailSettings.updatesFromKeenthemes.newsAboutKeenthemesProductsAndFeatureUpdates,
    tipsOnGettingMoreOutOfKeen: user.emailSettings.updatesFromKeenthemes.tipsOnGettingMoreOutOfKeen,
    thingsYouMissedSindeYouLastLoggedIntoKeen:
      user.emailSettings.updatesFromKeenthemes.thingsYouMissedSindeYouLastLoggedIntoKeen,
    newsAboutMetronicOnPartnerProductsAndOtherServices:
      user.emailSettings.updatesFromKeenthemes.newsAboutMetronicOnPartnerProductsAndOtherServices,
    ...
    <form className="card card-custom" onSubmit={formik.handleSubmit}>
      ...
      <div className="card-header py-3">
        <div className="card-title align-items-start flex-column">
          <h3 className="card-label font-weight-bolder text-dark">Email Settings</h3>
        ...
        <div className="card-body">
          <div className="row">
            ...
            <div className="col-lg-9 col-xl-6">
              <h5 className="font-weight-bold mb-6">Setup Email Notification:</h5>
            </div>
          </div>
          ...
          <div className="row">
            <label className="col-xl-3"></label>
            <div className="col-lg-9 col-xl-6">
              <h5 className="font-weight-bold mb-6">Activity Related Emails:</h5>
            </div>
          </div>
          ...
          <div className="row">
            <label className="col-xl-3"></label>
            <div className="col-lg-9 col-xl-6">
              <h5 className="font-weight-bold mb-6">Updates From Keenthemes:</h5>
            </div>
          </div>
          <div className="form-group row">
            <label className="col-xl-3 col-lg-3 col-form-label font-weight-bold text-left text-lg-right">
              ...
              <div className="checkbox-list">
                ...
                <label className="checkbox">
                  <input
                    ...
                    onChange={formik.handleChange}
                  />
                  <span></span>News about Metronic on partner products and other services
                </label>
                <label className="checkbox">
                  <input
                    type="checkbox"
