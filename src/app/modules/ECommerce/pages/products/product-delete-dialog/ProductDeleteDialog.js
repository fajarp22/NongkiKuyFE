  ...
  return (
    <Modal show={show} onHide={onHide} aria-labelledby="example-modal-sizes-title-lg">
      ...
      <Modal.Header closeButton>
        <Modal.Title id="example-modal-sizes-title-lg">Product Delete</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        {!isLoading && <span>Are you sure to permanently delete this product?</span>}
      ...
      <Modal.Footer>
        <div>
          ...
          <> </>
          <button type="button" onClick={deleteProduct} className="btn btn-delete btn-elevate">
            Delete
          </button>
        </div>
      </Modal.Footer>
