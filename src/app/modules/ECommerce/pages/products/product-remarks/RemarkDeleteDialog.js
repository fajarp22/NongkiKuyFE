  ...
  return (
    <Modal
      ...
      <Modal.Header closeButton>
        <Modal.Title id="example-modal-sizes-title-lg">Remark Delete</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        {!isLoading && <span>Are you sure to permanently delete this remark?</span>}
      ...
      <Modal.Footer>
        <div>
          ...
          <> </>
          <button type="button" onClick={deleteRemark} className="btn btn-primary btn-elevate">
            Delete
          </button>
        </div>
      </Modal.Footer>
