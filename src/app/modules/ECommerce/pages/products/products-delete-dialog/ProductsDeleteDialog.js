  ...
  return (
    <Modal show={show} onHide={onHide} aria-labelledby="example-modal-sizes-title-lg">
      ...
      <Modal.Header closeButton>
        <Modal.Title id="example-modal-sizes-title-lg">Products Delete</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        {!isLoading && <span>Are you sure to permanently delete selected products?</span>}
      ...
      <Modal.Footer>
        <div>
          ...
          <> </>
          <button type="button" onClick={deleteProducts} className="btn btn-primary btn-elevate">
            Delete
          </button>
        </div>
      </Modal.Footer>
